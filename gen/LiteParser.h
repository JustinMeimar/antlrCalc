...
class  LiteParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit LiteParser(antlr4::TokenStream *input);

  LiteParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  class  StatAssignExprContext : public StatContext {
  public:
    StatAssignExprContext(StatContext *ctx);
  ...
  class  StatExprContext : public StatContext {
  public:
    StatExprContext(StatContext *ctx);
  ...
  class  StatNewLineContext : public StatContext {
  public:
    StatNewLineContext(StatContext *ctx);
